...
namespace beautysoft.Controllers
{
    public class RolesController : Controller
    {
        ...
        public RolesController(BeautysoftnetContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Rols != null ? 
                          ...
                          Problem("Entity set 'BeautysoftnetContext.Rols'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BeautysoftnetContext.Rols'  is null.");
            }
            var rol = await _context.Rols.FindAsync(id);
            if (rol != null)
            {
